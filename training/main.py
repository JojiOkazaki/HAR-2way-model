...
def train(config):
    ...
    train_file_list = (DATASET_ROOT / train_file_list_rel) if train_file_list_rel else None
    val_file_list = (DATASET_ROOT / val_file_list_rel) if val_file_list_rel else None
